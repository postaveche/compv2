<div class="card-body">
 ...
 <div class="row">
  ...
  <div class="col-md-2"><div class="form-group"><label>Status</label><div class="custom-control custom-switch mt-2"><input type="hidden" name="active" value="0"><input id="active" type="checkbox" name="active" value="1" class="custom-control-input" {{ old('active', $banner->exists ? $banner->active : true) ? 'checked' : '' }}><label class="custom-control-label" for="active">Activ</label></div></div></div>
 </div>
