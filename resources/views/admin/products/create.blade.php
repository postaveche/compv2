                ...
                <form action="{{route('products.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" value="" class="form-control" id="Denumirea" name="name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="" class="form-control" id="keywords" name="keywords"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="fulldescription" name="text" rows="4"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Pretul produsului (USD)</label>
                            <input type="text" value="" class="form-control" id="price" name="price" placeholder="Pret"
                                   required>
                        </div>
                        <div class="form-group">
                            <label>Pret Special al produsului (USD)</label>
                            <input type="text" value="" class="form-control" id="specialprice" name="specialprice"
