<div class="produse row justify-content-center">
    @foreach($products as $product)
        ...
        <article class="product">
            <div class="img_thumb">
                <a href="/{{session('locale')}}/product/{{$product['slug']}}"><img class="img-fluid img_thumb" src="{{Storage::url('public/products/'.$thumb)}}{{(config('app.env') === 'production' ? '@300' : '')}}" alt="{{$product['name']}}"></a>
